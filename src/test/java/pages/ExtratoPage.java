...
public class ExtratoPage {
    ...
    String botaoExtrato = "//body/div[@id='__next']/div[1]/div[3]/div[2]/div[3]/a[1]/span[1]/img[1]";


    public void ExtratoPage(WebDriver driverDoTeste) {
    ...
    public void clicarExtrato(){
        ...
        driver.findElement(By.xpath(botaoExtrato)).click();}
